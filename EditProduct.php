                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h4 class="text-center font-weight-bold">Update Your Product </h4>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" id="full_name" class="form-control" name="product_id" value="<?php echo $product_id; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <select name="product_cat" value="<?php echo $product_cat; ?>" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <textarea name="product_desc" id="nid_number2" class="form-control"   value="<?php echo  $product_desc; ?>" rows="3" required></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 offset-md-4">
                                        <button type="submit" class="btn btn-success" name="update_pro">
                                           Update
                                        </button>
...
if (isset($_POST['update_pro'])) {    // when button is clicked
    ...
    if (isset($_SESSION['phonenumber'])) {
        ...
        $update_product ="update products set product_title='$product_title',product_cat='$product_cat', product_image='$product_image', product_price='$product_price', product_desc='$product_desc' where product_id='$product_id';";
