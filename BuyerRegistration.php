						...
						<div class="card-body border border-dark">
							<form name="my-form" action="BuyerRegistration.php" method="post">
								...
								<div class="form-group row">
									...
									<div class="col-md-6">
										<textarea type="text" id="present_address" class="form-control border border-dark" rows="3" name="address" placeholder="Address" required></textarea>
									</div>
								</div>
...
if (isset($_POST['register'])) {
	...
	if (strcmp($password, $confirmpassword) == 0) {
		...
		buyer_bank,buyer_pan,buyer_password) 
		values ('$name','$phonenumber','$address','$account','$pan',
		'$password')";
