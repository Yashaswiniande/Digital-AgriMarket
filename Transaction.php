        ...
        <table class="table">
            ...
            <tbody>
                ...
                if (isset($_SESSION['phonenumber'])) {
                    ...
                    $sel_price = "select * from orders where bno = '$sess_phone_number'";
                ...
                ?>
                                <tr>
                                    ...
                                    <td data-label="Amount"><?php echo $subtotal; ?> </td>
...
<?php
        ...
        <a href="bhome.php">
         ...
         <div class=" float-none float-sm-none float-md-none float-lg-right float-xl-rightcheckout" >
            <button class='btn btn-success btn-lg border border-dark'>Grand total = Rs <?php echo $total; ?> </button>
